...
class TheNecessaryNutrientsYoungMenTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('the_necessary_nutrients_young_men', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('the_necessary_nutrients_young_men');
    }
}
